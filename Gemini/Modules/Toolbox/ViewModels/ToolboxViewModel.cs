...
namespace Gemini.Modules.Toolbox.ViewModels
{
    ...
    public class ToolboxViewModel : Tool, IToolbox
    {
        ...
        public ToolboxViewModel(IShell shell, IToolboxService toolboxService)
        {
            ...
            ICollectionView groupedItems = CollectionViewSource.GetDefaultView(_items);
        ...
        private void Search(string searchTerm)
        {
            ...
            {
                foreach (ToolboxItemViewModel item in _items.Where(x => x.Name.ToUpper().Contains(searchTerm.ToUpper()) || x.Name.ToUpper().Equals(searchTerm.ToUpper())))
