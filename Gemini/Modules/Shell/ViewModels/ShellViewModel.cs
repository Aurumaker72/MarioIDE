...
#pragma warning restore 649
        ...
        public ILayoutItem ActiveLayoutItem
        {
            ...
            set
            {
                ...
                Debug.WriteLine("ActiveLayoutItem: " + _activeLayoutItem);
        ...
        protected override void OnViewLoaded(object view)
        {
            foreach (IModule module in _modules)
                foreach (ResourceDictionary globalResourceDictionary in module.GlobalResourceDictionaries)
        ...
        public override async Task ActivateItemAsync(IDocument item, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                IDocument currentActiveItem = ActiveItem;
