...
namespace Gemini.Framework.Commands
{
    ...
    public sealed class CommandHandlerWrapper
    {
        ...
        {
            MethodInfo updateMethod = commandHandlerInterfaceType.GetMethod("Update");
            MethodInfo runMethod = commandHandlerInterfaceType.GetMethod("Run");
        ...
        {
            MethodInfo populateMethod = commandHandlerInterfaceType.GetMethod("Populate");
            MethodInfo runMethod = commandHandlerInterfaceType.GetMethod("Run");
