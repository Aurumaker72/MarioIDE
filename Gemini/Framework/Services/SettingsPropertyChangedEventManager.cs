...
namespace Gemini.Framework.Services
{
        ...
        where TApplicationSettings : INotifyPropertyChanged
    {
        ...
        private readonly List<IWeakEventListener> _eventListeners = new();
            ...
            Action<TSettingsProperty> onPropertyChanged)
        {
            ...
            PropertyChangedEventListener<TSettingsProperty> listener = new PropertyChangedEventListener<TSettingsProperty>(_applicationSettings, property,
                onPropertyChanged);
