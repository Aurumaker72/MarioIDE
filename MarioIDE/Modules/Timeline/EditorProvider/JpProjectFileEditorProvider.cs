...
public class JpProjectFileEditorProvider : IEditorProvider
{
    private static readonly List<EditorFileType> Extensions = new()
    {
        new EditorFileType("JP Project File (.mide)" , ".mide")
    };
    ...
    public IDocument Create() => new TimelineViewModel(GameVersion.JP);
