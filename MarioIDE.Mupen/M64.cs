...
public class M64 : IM64
{
    ...
    public bool IsControllerPresent(Controller controller)
    {
        ...
        switch (controller)
        {
            case Controller.ControllerOne:
                controllerProperty = ControllerProperty.ControllerOnePresent;
                break;
            case Controller.ControllerTwo:
                controllerProperty = ControllerProperty.ControllerTwoPresent;
                break;
            case Controller.ControllerThree:
                controllerProperty = ControllerProperty.ControllerThreePresent;
                break;
            case Controller.ControllerFour:
                controllerProperty = ControllerProperty.ControllerFourPresent;
                break;
            default:
    ...
    public IEnumerable<InputModel> GetControllerInputs(Controller controller)
    {
        ...
        List<InputModel> inputs = new List<InputModel>(ControllerInputs.Count);
        ...
        int offset = (int)controller;
        for (int i = 0; i < ControllerInputs.Count; i += (int)ControllerCount)
        {
